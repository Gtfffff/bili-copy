...
<template>
  <div
    class="grid grid-cols-[repeat(3,auto)] grid-rows-2 grid-flow-row gap-y-[10px] flex-shrink-0 w-[258px] flex-auto text-gray-500 fill-gray-500"
  >
    <!-- 专栏 -->
    <a
      href="#"
      class="flex items-center justify-end w-full text-center font-normal hover:text-blue-500 hover:fill-blue-500"
    >
      <svg
        t="1642646834655"
        class="w-5 h-5"
